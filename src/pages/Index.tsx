...
export default function Index() {
  ...
  return (
    <Layout>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="xl" variant="solar">
                <Link to="/assessment">
                  {user ? "Start New Assessment" : "Get an Assessment"}
      ...
      {/* Features Section */}
      <section id="complete-solutions" className="py-20 bg-background">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group p-6 bg-card border shadow-card hover:shadow-card-lg transition-all duration-300"
              >
                <div className="w-12 h-12 bg-energy-green-light flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <ul className="space-y-4">
                {benefits.map((benefit, index) => (
                  ...
                  >
                    <div className="flex-shrink-0 w-6 h-6 bg-primary flex items-center justify-center">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-solar-gold/20 blur-2xl" />
              <div className="relative bg-card border shadow-card-xl p-8">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 gradient-hero flex items-center justify-center">
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-muted/50 p-3">
                      ...
                      <div className="font-bold text-success text-lg">₦85,000</div>
                    </div>
                    <div className="bg-muted/50 p-3">
                      <div className="text-xs text-muted-foreground">Payback Period</div>
                      <div className="font-bold text-primary text-lg">1.8 Years</div>
                    </div>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-dashed">
                    <span className="text-muted-foreground">Solar Panels</span>
                    <span className="font-medium">10 × 550W (Jinko)</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-dashed">
                    <span className="text-muted-foreground">Battery Storage</span>
                    <span className="font-medium">15 kWh (Lithium)</span>
                  </div>
                  <div className="flex justify-between items-center py-2 border-b border-dashed">
                    <span className="text-muted-foreground">Inverter</span>
                    <span className="font-medium">5.5 kW (Hybrid)</span>
                  </div>
                  <div className="flex justify-between items-center py-2 pt-4">
                    <span className="font-semibold text-lg">Total Investment</span>
                    <span className="font-bold text-primary text-xl">₦4,500,000</span>
                  </div>
                  <div className="flex gap-2 text-xs text-muted-foreground bg-primary/5 p-2 border border-primary/10">
                    <CheckCircle2 className="h-4 w-4 text-primary shrink-0" />
                    <span>Includes installation & 2-year maintenance</span>
                  </div>
                </div>
              </div>
            </motion.div>
